...
from Extract.weather.openweather_weather import fetch_timestamp_weather
...
if __name__ == '__main__':
    ...
    for weather_dict in weather:
        ...
        if verbose:
            append_to_json(weather_dict, os.path.join('json', 'WeatherInfo.json'))
        # Load
        ...
        if verbose:
            append_to_csv(weather, os.path.join('csv', 'WeatherInfo.csv'))
        # Load
