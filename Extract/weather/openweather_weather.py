...
def build_current_weather_url(latitude: float, longitude: float, api_key: str) -> str:
    ...
    :arg latitude: The latitude of the location for which weather data is requested.
    :arg longitude: The longitude of the location for which weather data is requested.
...
def fetch_current_weather(latitudes: List[float], longitudes: List[float], api_key: str) -> List[Dict]:
    """
    Fetches weather information for a list of latitude and
    longitude pairs using the OpenWeatherMap API.

    :arg latitudes: A list of latitudes for which to fetch weather information.
    :arg longitudes: A list of longitudes for which to fetch weather information.
    :arg api_key: The API key for accessing the OpenWeatherMap API.
